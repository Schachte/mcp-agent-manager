    ...
    >
      <path
        ...
        style={{
          ...
          transform: 'rotate(330deg) scaleY(0.94) rotate(-330deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(300deg) scaleY(1.01248) rotate(-300deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(270deg) scaleY(1.15715) rotate(-270deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(240deg) scaleY(1.16381) rotate(-240deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(210deg) scaleY(1.27452) rotate(-210deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(180deg) scaleY(1.17785) rotate(-180deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(150deg) scaleY(1.03619) rotate(-150deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(120deg) scaleY(0.925) rotate(-120deg)',
        }}
      ></path>
      <path
      ...
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(60deg) scaleY(1.045) rotate(-60deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(30deg) scaleY(1.03) rotate(-30deg)',
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: '50px 50px',
          transform: 'rotate(0deg) scaleY(0.955) rotate(0deg)',
        }}
      ></path>
    </svg>
  );
